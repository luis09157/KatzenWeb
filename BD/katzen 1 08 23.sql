CREATE DATABASE  IF NOT EXISTS `katsenbd` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `katsenbd`;
...
INSERT INTO `campaña` VALUES (1,'campa;a1','2023-07-09 17:34:03',1,'2023-04-09 17:34:03'),(2,'campa;a 2','2023-07-09 17:37:29',1,'2023-04-09 17:37:29'),(3,'Veronica','2023-07-09 17:37:29',1,'2023-04-09 19:39:50'),(4,'Campaña de las buenas','2023-07-16 00:00:00',1,'2023-04-11 13:18:23'),(5,'Campa;a Julio 16','2023-07-16 00:00:00',1,'2023-07-11 13:19:54'),(6,'cholos','2023-07-16 00:00:00',1,'2023-04-11 13:25:45'),(7,'hola','2023-07-07 00:00:00',1,'2023-04-11 13:26:05'),(8,'dsfsd','2023-07-06 00:00:00',1,'2023-07-16 18:29:58'),(9,'dsfsd','2023-07-06 00:00:00',1,'2023-07-16 18:29:58'),(10,'dsfsd','2023-07-06 00:00:00',1,'2023-07-16 18:29:58'),(11,'dsfsd','2023-07-06 00:00:00',1,'2023-07-16 18:29:58'),(12,'dsfsd','2023-07-06 00:00:00',1,'2023-07-16 18:29:58'),(13,'dsf','2023-07-14 00:00:00',1,'2023-07-16 18:37:36');
/*!40000 ALTER TABLE `campaña` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `campaña_detalle`
--

DROP TABLE IF EXISTS `campaña_detalle`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `campaña_detalle` (
  `idCampañaDetalle` int NOT NULL AUTO_INCREMENT,
  `idCampaña` int DEFAULT NULL,
  `idPaciente` int DEFAULT NULL,
  `fechaAlta` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`idCampañaDetalle`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `campaña_detalle`
--

LOCK TABLES `campaña_detalle` WRITE;
/*!40000 ALTER TABLE `campaña_detalle` DISABLE KEYS */;
INSERT INTO `campaña_detalle` VALUES (1,1,1,'2023-07-11 17:17:29'),(2,1,73,'2023-07-11 17:22:15'),(3,1,74,'2023-07-11 17:36:25'),(4,1,75,'2023-07-11 17:38:26'),(5,1,76,'2023-07-11 17:39:35'),(6,1,77,'2023-07-11 17:43:43'),(7,5,78,'2023-07-11 17:48:25');
/*!40000 ALTER TABLE `campaña_detalle` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `expediente` VALUES (1,'20230623-55','2023-06-23 16:23:48',1),(2,'20230703-59','2023-07-03 15:12:08',1),(3,'20230709-64','2023-07-09 14:47:01',1),(4,'20230709-65','2023-07-09 15:02:55',1),(5,'20230709-66','2023-07-09 15:20:50',1),(6,'20230709-67','2023-07-09 15:22:28',1),(7,'20230709-69','2023-07-09 16:05:21',1),(8,'20230711-71','2023-07-11 15:24:35',1),(9,'20230711-79','2023-07-11 17:49:15',1);
...
INSERT INTO `paciente` VALUES (67,'EJEMPLO',32,4,2,172,'2023-07-09','fdsf','/img/carita-felipe.jpg',34,6,1,'fsdfd',0,'2023-07-09 15:22:28'),(68,'EJEMPLO',32,5,1,8,'2023-07-09','dsf','/img/addPet/20230709152032.jpg',34,6,1,'hghdf',0,'2023-07-09 15:25:45'),(69,'EJEMPLO',0,2,2,178,'2023-07-09','Blanco','/img/carita-felipe.jpg',33,7,1,'',0,'2023-07-09 16:05:21'),(70,'EJEMPLO',0,3,1,8,'2023-07-09','dsf','/img/carita-felipe.jpg',34,6,1,'',0,'2023-07-09 16:17:49'),(71,'FGDFG',32,6,1,2,'2023-07-11','dsf','/img/carita-felipe.jpg',32,8,1,'',1,'2023-07-11 15:24:35'),(72,'TOKIO GOUL',32,5,1,9,'2023-07-11','Blanco','/img/carita-felipe.jpg',34,6,1,'ksksk',1,'2023-07-11 15:25:13'),(73,'EJEMPLO',32,4,1,10,'2023-07-11','dsfsd','/img/carita-felipe.jpg',34,6,1,'kk',1,'2023-07-11 17:22:15'),(74,'EJEMPLO',32,5,2,172,'2023-07-11','dsf','/img/carita-felipe.jpg',34,6,1,'',1,'2023-07-11 17:36:25'),(75,'NIEVES',32,5,2,172,'2023-07-11','gdfg','/img/carita-felipe.jpg',33,7,1,'sdsd',1,'2023-07-11 17:38:26'),(76,'EJEMPLO',32,4,1,10,'2023-07-11','Blanco','/img/carita-felipe.jpg',34,6,1,'sdads',1,'2023-07-11 17:39:35'),(77,'EJEMPLO',32,5,1,9,'2023-07-11','Blanco','/img/carita-felipe.jpg',32,8,1,'dsfds',1,'2023-07-11 17:43:43'),(78,'EJEMPLO',32,3,1,14,'2023-07-11','Blanco','/img/carita-felipe.jpg',32,8,1,'dsfsd',1,'2023-07-11 17:48:25'),(79,'EJEMPLO',32,4,2,171,'2023-07-11','fds','/img/carita-felipe.jpg',35,9,1,'sdfdsf',0,'2023-07-11 17:49:15');
...
--
-- Dumping events for database 'katsenbd'
--

--
-- Dumping routines for database 'katsenbd'
--
/*!50003 DROP PROCEDURE IF EXISTS `get_campaña_mes` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_campaña_mes`()
BEGIN
	SELECT idCampaña,nombre,fechaCampaña FROM campaña WHERE fechaAlta BETWEEN DATE_FORMAT(now(),'%Y-%m-01') AND LAST_DAY(NOW());
END ;;
DELIMITER ;
...
BEGIN
   ...
   insert into paciente (nombre,peso,idSexo,idEspecie,idRaza,fechaNacimiento,color,img, rasgosParticulares, campaña,  idCliente,idExpediente) 
   values(UPPER(v_nombre),v_peso,v_idSexo,v_idEspecie,v_idRaza,now(),v_color,v_img, v_rasgosParticulares,v_radioPaciente , v_idCliente,0);
   ...
   SET RESULT =  (SELECT idExpediente from paciente
    ...
    IF v_radioPaciente = 1
    THEN
		insert into campaña_detalle(idCampaña,idPaciente) values(v_idCampaña,V_IDPAC);
    END IF;
...
-- Dump completed on 2023-08-01  9:24:52
